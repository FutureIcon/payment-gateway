 ...
 * 请求被扫支付API需要提交的数据
 */
public class UnifiedPayReqData {
    ...
    public UnifiedPayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag){
