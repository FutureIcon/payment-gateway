...
//@Component
public class WechatRefund extends AbstractWechatPaymentOperation {
	...
	public void executeWechatTransaction(PayTransactionDTO dto) throws Exception  {
		...
		ScanPayRefundBusinessBridge bridge = new ScanPayRefundBusinessBridge();
        ...
        updateDtoByRefundResponse(dto, refundResData);
		
	}

	protected void updateDtoByRefundResponse(PayTransactionDTO dto, RefundResData refundResData) {
