...
public class UnifiedPayBusinessBridge implements IBridge {
    ...
    public String getOutTradeNo(){
        return  LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmssSSS")) + ThreadLocalRandom.current().nextLong(1000000);
    }
